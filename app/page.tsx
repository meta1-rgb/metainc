    ...
    <div className="flex flex-col">
      ...
      <section className="relative bg-slate-50 py-24 md:py-40 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold text-[#8C8C8C] leading-tight">
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <button className="bg-white text-[#8C8C8C] border border-slate-200 px-8 py-4 rounded-lg font-bold hover:bg-slate-50">포트폴리오 보기</button>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 bg-[#8C1515]">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-2xl">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <button className="md:col-span-2 bg-[#8C8C8C] text-white py-4 rounded-lg font-bold text-lg hover:bg-[#707070] transition">문의하기</button>
          </form>
        </div>
      </section>
    </div>
