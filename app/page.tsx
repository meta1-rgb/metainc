    ...
    <div className="flex flex-col">
      ...
      <section className="relative bg-slate-50 py-24 md:py-40 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <span className="text-blue-600 font-bold tracking-widest uppercase text-sm">Creativity + Tech Solution</span>
          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight">
            데이터 기반의 <br className="md:hidden" />
            <span className="text-blue-600">통합 디지털 마케팅</span>
          </h1>
          <p className="mt-6 text-lg text-slate-600 max-w-2xl mx-auto">
            고객사 브랜드 가치를 극대화하고 소비자를 하나로 연결하는<br className="hidden md:block" /> 최적의 마케팅 서비스를 제공합니다.
          </p>
          <div className="mt-10 flex justify-center gap-4">
            <button className="bg-blue-600 text-white px-8 py-4 rounded-lg font-bold shadow-lg hover:bg-blue-700">회사소개서 다운로드</button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="p-8 border border-gray-100 rounded-2xl hover:shadow-xl transition-shadow bg-slate-50">
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-6 text-blue-600 font-bold">0{idx+1}</div>
      ...
      <section className="py-24 px-4 bg-blue-600">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-2xl">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <input type="text" placeholder="고객사명" className="p-4 border border-gray-200 rounded-lg focus:outline-blue-600" />
            <input type="text" placeholder="담당자명" className="p-4 border border-gray-200 rounded-lg focus:outline-blue-600" />
            <input type="text" placeholder="연락처" className="p-4 border border-gray-200 rounded-lg focus:outline-blue-600" />
            <select className="p-4 border border-gray-200 rounded-lg focus:outline-blue-600">
              <option>관심 상품 선택</option>
              <option>검색광고</option>
              <option>바이럴광고</option>
              <option>기타</option>
            </select>
            <textarea placeholder="문의내용" className="md:col-span-2 p-4 border border-gray-200 rounded-lg h-32 focus:outline-blue-600"></textarea>
